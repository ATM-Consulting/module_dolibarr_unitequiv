 ...
 */
class unitequivbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "unitequiv@unitequiv";
    public $boxlabel;
    public $depends = array("unitequiv");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/unitequiv/class/unitequiv.class.php";
